        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p>
                We retain all generated images for <strong>60 days</strong> from creation. After this period, images are automatically removed from our servers. 
                Be sure to download any images you want to keep permanently before the 60-day retention period expires.
              </p>
            </div>
          </div>
        </div>
